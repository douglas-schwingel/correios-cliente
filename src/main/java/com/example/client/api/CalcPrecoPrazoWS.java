    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.example.client.api.CalcPrecoPrazoWS.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.example.client.api.CalcPrecoPrazoWS.class.getResource(".");
